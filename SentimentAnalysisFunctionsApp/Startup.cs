...
namespace SentimentAnalysisFunctionsApp
{
    ...
    public class Startup : FunctionsStartup
    {
        ...
        //private readonly string modelNameZip = "sentiment_model.zip";
        public Startup()
        {
            ...
            {
                _modelPath = Path.Combine("C:\\Users\\emils\\source\\repos\\SentimentAnalysisFunctionsApp\\SentimentAnalysisFunctionsApp\\MLModels", "sentiment_model.zip");
            }
            else
            {
